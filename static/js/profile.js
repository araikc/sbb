(function ($) {
    ...
    jQuery(document).ready(function($){
        ...
        $("#inv-amount").on("change paste keyup", function() {
           ...
           $('#prof-value1').text(sign.concat(($(this).val()*0.03*1).toString().substring(0, 8)));
           $('#prof-value2').text(sign.concat(($(this).val()*0.03*30).toString().substring(0, 8)));
           $('#prof-value3').text(sign.concat(($(this).val()*0.03*365).toString().substring(0, 8)));
        });
